    ...
    internal class FlightManager
    {
       ...
       */
        ...
        */
        ...
        // TODO (Completed by  JOEL GEBRENIGUS)
        ...
        public static List<Flight> findFlights(string from, string to, string weekday)
        {
            ...
            foreach (Flight flight in flights)
            {
                bool fromMatch = from.Equals(WEEKDAY_ANY) || flight.From.Equals(from);
                bool toMatch = to.Equals(WEEKDAY_ANY) || flight.To.Equals(to);
                bool weekdayMatch = weekday.Equals(WEEKDAY_ANY) || flight.Weekday.Equals(weekday);

                // Check if all criteria are met
                if (fromMatch && toMatch && weekdayMatch)
                {
                    found.Add(flight);
                }
            }
